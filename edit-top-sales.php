       ...
       <!-- // Top Header -->
		...
		<div id="breadcrumb" class="section" style="margin-bottom:-50px;">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Edit Top Sales</h3>
						<ul class="breadcrumb-tree">
							<li><a href="dashboard.php">Dashboard</a></li>
							<li class="active">Edit Top Sales</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
		...
		<?php   
			...
			$query="SELECT id, p_name, p_image, p_price, p_category FROM products WHERE p_category='Top Sales'";
