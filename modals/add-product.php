            ...
            <div class="md-form">
               <div class="col-sm-4">
                <label for="productImage" style="color:black;">Product Category:</label>
                 ...
                 <div class="col-sm-8">
                  <input type="text" id="p_category" name="p_category" class="form-control" placeholder="Product Category" class="file-loading" style="width:auto;" required="">
                   </div>
                  </div>
                  <br><br><br>
                 ...
                 <div class="col-sm-8">
                  <select class="select-control" id="p_section" name="p_section" required="">
                      <option value="Select">Select Section</option>
                        <option value="Section-1">Main</option>
                        <option value="Section-2">New Arivals</option>
                        <option value="Section-2">Deals of the Day</option>
                  </select>
                   </div>
                  </div><br><br><br>
                   ...
                   <div class="modal-footer">
                    <button type="submit" name="submit" class="add-btn" data-loading-text="Loading..."><i class="glyphicon glyphicon-ok-sign"></i> ADD PRODUCT</button>
